...
export const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20A7 7 0 0 1 4 13V8a5 5 0 0 1 5-5h2a5 5 0 0 1 5 5v5a7 7 0 0 1-7 7Zm0 0V8"/><path d="M12 2v6"/></svg>
);
...
export const ScienceIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M10.1 2.18a9.93 9.93 0 0 1 3.8 0"/><path d="M12 22a9.93 9.93 0 0 1-3.8-19.82"/><path d="M14.24 3.48c.84.2 1.63.53 2.34.99"/><path d="M17.61 5.42a4.43 4.43 0 0 1 1.8 1.8"/><path d="M19.58 8.39c.46.71.79 1.5.99 2.34"/><path d="M21.82 13.9a9.93 9.93 0 0 1 0-3.8"/><path d="M20.57 14.24c-.2.84-.53 1.63-.99 2.34"/><path d="M18.58 17.61a4.43 4.43 0 0 1-1.8 1.8"/><path d="M15.61 19.58c-.71.46-1.5.79-2.34.99"/><path d="M4.18 10.1a9.93 9.93 0 0 1 15.64 0"/><circle cx="12" cy="12" r="2"/><path d="m19.07 4.93-1.4-1.42"/><path d="m4.93 19.07 1.4 1.42"/></svg>
);

export const PlantIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M7 20-4 13"/><path d="M21 20h-2a4 4 0 0 0-4-4V4a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v12H5a2 2 0 0 0-2 2h2a2 2 0 0 0 2-2V9a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v11h2a2 2 0 0 0 2-2h-2"/><path d="M17 20v-2a2 2 0 0 0-2-2h-2"/></svg>
);
